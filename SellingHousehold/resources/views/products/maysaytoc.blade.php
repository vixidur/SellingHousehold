...
<div class="product-section">
        <h2>CÁC SẢN PHẨM: MÁY SẤY TÓC !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/saytoc1.png') }}" alt="Product 3">
                <h3>Máy Sấy Tóc Elmich Diamond EL8406</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/saytoc2.png') }}" alt="Product 3">
                <h3>Máy Sấy Tóc Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/saytoc3.png') }}" alt="Product 3">
                <h3>Máy Sấy Tóc Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/saytoc4.png') }}" alt="Product 3">
                <h3>Máy Sấy Tóc Elmich EL8424</h3>
                <p class="price">
