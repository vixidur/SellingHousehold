    ...
    <div class="product-section">
        ...
        <div class="product-container">
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/coc1.png') }}" alt="Product 3">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/coc2.png') }}" alt="Product 3">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/coc3.png') }}" alt="Product 3">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/coc4.png') }}" alt="Product 3">
                <h3>Cốc giữ nhiệt inox 304 Elmich</h3>
                <p class="price">
