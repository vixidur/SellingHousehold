...
<div class="product-section">
        <h2>CÁC SẢN PHẨM: BẾP ĐIỆN !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/bep1 copy.png') }}" alt="Product 3">
                <h3>Bếp Điện Elmich Diamond EL8406</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/bep2 copy.png') }}" alt="Product 3">
                <h3>Bếp Điện Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/bep4 copy.png') }}" alt="Product 3">
                <h3>Bếp Điện Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/bep3 copy.png') }}" alt="Product 3">
                <h3>Bếp Điện Elmich EL8424</h3>
                <p class="price">
