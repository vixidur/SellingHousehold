...
<div class="product-section">
        <h2>CÁC SẢN PHẨM: MÁY XAY !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/mayxay1.png') }}" alt="Product 3">
                <h3>Máy Xay đa năng Elmich Diamond EL8406</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/mayxay2.png') }}" alt="Product 3">
                <h3>Máy Xay đa năng Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/mayxay3.png') }}" alt="Product 3">
                <h3>Máy Xay đa năng Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/mayxay4.png') }}" alt="Product 3">
                <h3>Máy Xay đa năng Elmich EL8424</h3>
                <p class="price">
