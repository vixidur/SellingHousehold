    ...
    <div class="product-section">
        ...
        <div class="product-container">
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/hop1.png') }}" alt="Product 3">
                <h3>Hộp cơm 2 tầng inox </h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/hop4.png') }}" alt="Product 3">
                <h3>Hộp cơm 2 tầng inox 304 Elmich</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/hop2.png') }}" alt="Product 3">
                <h3>Hộp cơm thức ăn giữ nhiệt Inox 316 Elmich</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/hopcom2.png') }}" alt="Product 3">
                <h3>Hộp cơm thức ăn Inox 316 Elmich</h3>
                <p class="price">
