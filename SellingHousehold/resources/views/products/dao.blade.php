...
<div class="product-section">
        ...
        <div class="product-container">
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/dao1.png') }}" alt="Product 3">
                <h3>Dao thái đa năng Elmich Diamond EL8406</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/dao3.png') }}" alt="Product 3">
                <h3>Dao đa năng Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/dao2.png') }}" alt="Product 3">
                <h3>Dao đa năng Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/dao4.png') }}" alt="Product 3">
                <h3>Dao đa năng Elmich EL8424</h3>
                <p class="price">
