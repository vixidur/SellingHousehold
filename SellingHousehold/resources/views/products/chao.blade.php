...
<div class="header">
    ...
    <div class="product-section">
        <h2>CÁC SẢN PHẨM: CHẢO !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/chao1.png') }}" alt="Product 3">
                <h3>Chảo Inox dập nguyên khối Elmich</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/chao2.png') }}" alt="Product 3">
                <h3>Chảo Inox chống dính dập nguyên khối Elmich</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/chao3.png') }}" alt="Product 3">
                <h3>Bộ nồi inox nguyên khối Elmich Trimax classic</h3>
                <p class="price">
                <span class="new-price">156.000đ</span>
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/chao4.png') }}" alt="Product 3">
                <h3>Chảo inox nguyên khối Elmich</h3>
                <p class="price">
