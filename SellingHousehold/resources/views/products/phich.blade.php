...
<link rel="stylesheet" href="{{ asset('css/cart.css') }}">
    <div class="product-section">
        <h2>CÁC SẢN PHẨM: PHÍCH GIỮ NHIỆT !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/phich1.png') }}" alt="Product 3">
                <h3>Bình giữ nhiệt gia đình inox 304  </h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/phich2.png') }}" alt="Product 3">
                <h3>Bình giữ nhiệt gia đình inox 304 Elmich </h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/phich3.png') }}" alt="Product 3">
                <h3>Bình giữ nhiệt inox 304 Elmich EL8364</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/phich4.png') }}" alt="Product 3">
                <h3>Bình giữ nhiệt gia đình inox 304 Elmich EL8343</h3>
                <p class="price">
