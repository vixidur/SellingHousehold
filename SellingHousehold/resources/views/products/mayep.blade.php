...
<div class="product-section">
        <h2>CÁC SẢN PHẨM: MÁY ÉP !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/mayep1.png') }}" alt="Product 3">
                <h3>Máy Ép đa năng Elmich Diamond EL8406</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/mayep2.png') }}" alt="Product 3">
                <h3>Máy Ép đa năng Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/mayep3.png') }}" alt="Product 3">
                <h3>Máy Ép đa năng Elmich Ultra Sharp EL8424</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/mayep4.png') }}" alt="Product 3">
                <h3>Máy Ép đa năng Elmich EL8424</h3>
                <p class="price">
