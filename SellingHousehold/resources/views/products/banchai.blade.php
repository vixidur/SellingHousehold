...
<div class="product-section">
        <h2>CÁC SẢN PHẨM: BÀN CHẢI ĐIỆN !</h2>
        <div class="product-container">
            <div class="product-card">
                <div class="discount">Giảm 50%</div>
                <img src="{{ asset(path: 'images/Products/banchai.png') }}" alt="Product 3">
                <h3>Bàn Chải Điện Elmich Diamond EL8406</h3>
                <p class="price">
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/banchai3.png') }}" alt="Product 3">
                <h3>Bàn Chải Điện Elmich Ultra Sharp EL8424</h3>
                <p class="price">
                <span class="new-price">546.000đ</span>
                <span class="old-price">950.000đ</span>
                </p>
                <button class="add-to-cart">
                    <i class="fa fa-cart-plus"></i>
                </button>
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/banchai2.png') }}" alt="Product 3">
                <h3>Bàn Chải Điện Elmich Ultra Sharp EL8424</h3>
                <p class="price">
                <span class="new-price">756.000đ</span>
            ...
            <div class="product-card">
                ...
                <img src="{{ asset(path: 'images/Products/banchai4.png') }}" alt="Product 3">
                <h3>Bàn Chải Điện Elmich EL8424</h3>
                <p class="price">
                <span class="new-price">579.000đ</span>
